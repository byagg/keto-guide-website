...
const products = [
  {
    ...
    "description": "Pure organic MCT oil from coconuts rich in C8 and C10. Flavorless and odorless, ideal for bulletproof coffee."
  },
  {
    "name": "Nature's Way Organic MCT Oil",
    "rating": 4.7,
    "link": "https://www.amazon.com/Natures-Way-Organic-MCT-Oil/dp/B0181U4X06",
    "description": "Affordable and high-quality MCT oil that provides quick energy for the brain and supports fat burning."
  },
  {
    "name": "Bulletproof Brain Octane C8 MCT Oil",
    "rating": 4.6,
    "link": "https://www.amazon.com/Bulletproof-Brain-Octane-Oil-Ounces/dp/B00P8E0QQG",
    "description": "Purest form of C8 MCT oil for maximum ketone production and mental clarity. Gold standard in the category."
  }
];
