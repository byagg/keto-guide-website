...
const products = [
  {
    ...
    "description": "Classic protein bars with high fiber content and minimal net carbs. Wide variety of flavors available."
  },
  {
    "name": "IQBAR Brain and Body Plant Protein Bars",
    "rating": 4.6,
    "link": "https://www.amazon.com/IQBAR-Brain-Body-Plant-Protein/dp/B07G7L9Z1M",
    "description": "Vegan keto bars focused on brain health. Contains clean ingredients and no sugar alcohols."
  },
  {
    "name": "Perfect Keto Bars",
    "rating": 4.5,
    "link": "https://www.amazon.com/Perfect-Keto-Bar-Chocolate-Almond/dp/B07L9P6S9W",
    "description": "Designed specifically for ketosis with minimal impact on blood sugar levels. Contains collagen and healthy fats."
  }
];
